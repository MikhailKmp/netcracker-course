...
public class ContactCardTests {
	private static final String GOOD[] = {
			...
			"FN:Alexander Kharichkin\r\nORG:Netcracker Technology\r\nBDAY:07-09-1988\r\nTEL;TYPE=CELL:9032606540\r\nTEL;TYPE=WORK:4959269347"
	};
	...
	public void getPhone2(){
		String text = GOOD[2];
		ContactCard card = getCard(text);
		assertEquals("getPhone(\"CELL\") failed with this text:\n"+text+"\n",
				"(903) 260-6540", card.getPhone("CELL"));
	}
